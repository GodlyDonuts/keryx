...
RoleBeacon treats every remote feed and every field inside it as untrusted data. Feed values are
...
RoleBeacon stores no applicant profile, résumé, authentication token, Discord credential, or job
